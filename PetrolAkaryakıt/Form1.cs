...
namespace PetrolAkaryakıt
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                baglanti.Open();
                OleDbCommand komut = new OleDbCommand("insert into tblhareket (PLAKA, BENZINTURU, LITRE, FIYAT) values (@p1,@p2,@p3,@p4)", baglanti);
